...
public class RoomRVAdapter extends ListAdapter<Space, RoomRVAdapter.ViewHolder> {
    ...
    @NonNull
    @Override
    public RoomRVAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RoomRVAdapter.ViewHolder holder, int position) {
